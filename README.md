...
<p>
  ...
  <a href="https://github.com/VibeCodeBlogger-Public" target="_blank" rel="noopener"><img alt="Open-source org on GitHub" src="https://img.shields.io/badge/Open--source_org-181717?style=for-the-badge&logo=github&logoColor=white"></a>
</p>
...
[![LLM cost](https://img.shields.io/badge/LLM%20cost-free-2ea043)](https://github.com/VibeCodeBlogger-Public/paperclip-hermes-paperclip-adapter-integration-free-glm-4.6-zai-minimax-llm-windows-wsl2)
...
### [AI-agent setup instructions — Claude Code status line (context-window usage bar + model · effort · tokens)](https://github.com/VibeCodeBlogger-Public/ai-agent-setup-instructions-claude-code-statusline-context-window-usage-bar-model-tokens-bash)
...
**[💻 Source &amp; install](https://github.com/VibeCodeBlogger-Public/ai-agent-setup-instructions-claude-code-statusline-context-window-usage-bar-model-tokens-bash)**
